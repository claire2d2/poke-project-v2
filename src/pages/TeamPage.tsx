...
const TeamPage = () => {
  ...
  return (
    <div className="TeamPage flex h-full w-full items-stretch ">
      ...
      <div className="TeamView relative overflow-scroll no-scrollbar h-full w-full md:basis-2/3 flex flex-col md:flex-row md:flex-wrap gap-3 items-center justify-around md:justify-center pt-2">
