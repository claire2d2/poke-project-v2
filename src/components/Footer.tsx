const Footer = () => {
  return (
    <footer className="bg-transparent">
      <div className="hidden sm:block text-center p-3 border dark:border-slate-200 rounded-t-2xl fixed bottom-0 left-0 bg-white dark:bg-slate-500">
        <a
      ...
      <div className="hidden sm:flex text-center items-center gap-3 p-3 border dark:border-slate-200 rounded-t-2xl fixed bottom-0 right-0 bg-white dark:bg-slate-500">
        <a
