...
const TeamMember: React.FC<{
  ...
  return (
    ...
    >
      <div className="group flex flex-col items-center justify-center max-w-60 border dark:border-slate-500 dark:bg-stone-300 rounded-xl shadow hover:shadow-lg p-4 hover:bg-blue-50 transition-all">
        <h1
        ...
        <img
          className={`pokeball h-40 w-40 rounded-full m-4 ${
            pokeId
              ? "bg-orange-100 dark:bg-stone-200 group-hover:bg-orange-200 group-hover:scale-105 "
              : "bg-gray-200"
          } transition-all`}
          src={
            pokeId
